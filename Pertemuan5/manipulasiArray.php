...
$hasil = array_push($hari, "Kamis", "Jum'at"); // menambah beberapa elemen pada akhir array
print_r($hari);
echo "<hr>";
...
$hasil = array_unshift($hari, "element", "ditambahkan"); // menambah beberapa elemen pada akhir array
print_r($hari);
